const Checklist = (() => {
  ...
  const COLS = [
    ...
    { key: 'product',      label: '예약상품',   w: 32 },
    { key: 'visit_count',  label: '방문횟수',   w: 32 },
    { key: 'name',         label: '예약자성함', w: 52 },
    { key: 'reserved',     label: '예약人',     w: 26 },
    { key: 'actual',       label: '입장人',     w: 26 },
    ...
    { key: 'adult_only',   label: '성인만',     w: 28 },
    { key: 'extra_hour',      label: '시간추가',   w: 32 },
